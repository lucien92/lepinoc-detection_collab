...
path_csv = "/content/lepinoc-detection_for_collab/classif/convert_and_analyse_data/correct_list.csv"
...
error = []
with open('/content/lepinoc-detection_for_collab/classif/convert_and_analyse_data/especes.csv', 'w') as f:
    f.write('Especes,0\n')
    for item in L:
        path_to_specie = f'/content/drive/MyDrive/sets_above30/Pictures_melange/{item}'
        try:
