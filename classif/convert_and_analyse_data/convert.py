...
path_to_images = "/content/drive/MyDrive/sets_above30/data"
...
try:
    os.mkdir("/content/drive/MyDrive/sets_above30/crop/")
except:
    pass
    ...
    for annot in os.listdir(folder_ann):
        ...
        with open(annot_path, 'r') as f:
            ...
            for line in lines:
                ...
                try:
                    os.mkdir(f'/content/drive/MyDrive/sets_above30/crop/{label}') #attention il faut changer les labels à chaque folder car le 1 du dossier 1 n'est pas celui du dossier 4 (pour les 4 grands dossier d'annotations)
                except:
                    pass
                cv2.imwrite(f'/content/drive/MyDrive/sets_above30/crop/{label}/{annot[:-4]}_{label}.jpg', crop)
                print(f'crop saved to /content/drive/MyDrive/sets_above30/crop/{label}/{annot[:-4]}_{label}.jpg')
