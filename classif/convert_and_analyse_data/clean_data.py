...
#maintenant ojn veut changer le csv /content/lepinoc-detection_for_collab/classif/convert_and_analyse_data/Liste_especes_IA_Lepi_noc_.csv et le csv 
#/content/lepinoc-detection_for_collab/classif/convert_and_analyse_data/especes.csv pour qu'ils ne contiennent plsu que les noms des folder encore présents

#on commence par le csv Liste_especes_IA_Lepi_noc_.csv


df = pd.read_csv("/content/lepinoc-detection_for_collab/classif/convert_and_analyse_data/Liste_especes_IA_Lepi_noc_.csv", delimiter = ";")
...
#maintenant on veut changer ce dataframe en csv  /content/lepinoc-detection_for_collab/classif/convert_and_analyse_data/new_list.csv

df.to_csv("/content/lepinoc-detection_for_collab/classif/convert_and_analyse_data/correct_list.csv", sep=";", index=False)
