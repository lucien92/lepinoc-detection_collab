...
try:
   os.mkdir('/content/lepinoc-detection_for_collab/classif/scrapping/Lepidoptera')
except:
...
os.chdir('/content/lepinoc-detection_for_collab/classif/scrapping/Lepidoptera')
