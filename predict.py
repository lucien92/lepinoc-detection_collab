...
def parse_opt(): #tous les arguments à rentrer
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/content/lepinoc-detection_for_collab/models/lepidoptera.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='/content/drive/MyDrive/sets_above30/test_detect', help='file/dir/URL/glob, 0 for webcam')
